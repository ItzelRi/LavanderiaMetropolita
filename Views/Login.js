...
const LoginUser = async() =>{
    try {
      ...
      Alert.alert("Algo salio mal", `No se ha iniciado sesion, ${error}`)
    }
  }
  ...
  return (
    ...
    <View style={styles.containerMain}>
        ...
        <View style={styles.containerContent}>
          ...
          <Pressable style={styles.send} onPress={() => LoginUser()} >
            <Text style={styles.textButton}>Enviar</Text>
          </Pressable>
        </View>
          <View style={styles.containerFooter}>
            <Text style={styles.containerFooter}>¿Olvidaste tu contraseña?</Text>
            <Text style={styles.containerFooter} onPress={() => navigate("Register")}> ¿Aun no tienes cuenta? Registrate</Text>
      </View>
    </View>
  </>
  );
